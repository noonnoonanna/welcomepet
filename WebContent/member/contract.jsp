...
제 1 조 (목적) 
이 이용약관(이하 '약관')은 주식회사 웰컴펫(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 jjang0u.com서비스의 가입조건 및 이용에 관한 다음의 제반 사항과 기타 기본적인 사항을 구체적으로 규정함을 목적으로 합니다.

제 2 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 웰컴펫 웹사이트(www.웰컴펫.com 이하 '웰컴펫웹')에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
		...
		<div id="agree">
			<label><input type="radio" name="okon1"> 동의함</label> &nbsp; &nbsp; &nbsp; 
			<label><input type="radio" name="okon1" checked> 동의안함</label>
		</div>
		<input class="nextBtn" type="button" value="다음단계" onclick="go_next()">
	</form>
</article>
